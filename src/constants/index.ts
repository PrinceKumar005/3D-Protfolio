import { CounterItem } from "./index.d";
...
export const words: { text: string; imgPath: string }[] = [
...
export const abilities: { imgPath: string; title: string; desc: string }[] = [
    {
...
export const techStackImgs: { name: string; imgPath: string }[] = [
...
export const expLogos: { name: string; imgPath: string }[] = [
...
export const socialImgs: { name: string; url: string; imgPath: string }[] = [
    {
        name: "insta",
